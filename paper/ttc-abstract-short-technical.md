...
For our automations, we use **Cursor Cloud Automations** [[4](#sources)] to take a development-ready issue through implementation, QA, and bounded repair to a PR. Agents execute; developers approve ready issues and review every result.
...
We will show the live automation path at https://cursor.com/t/trimble/automations, walk through how we applied the framework to the skipped-acceptance-criterion Modus threshold case, and run a first CLI inspection.

**Takeaways:**

1. Automate development so people can focus on reviewing and merging—faster production becoming faster delivery.
2. Rate whether a setup earns trust, find the weakest control with the framework, and improve it before trusting outcomes.
3. Leave knowing how to inspect your repository with `pip install pdlc-validity`.
